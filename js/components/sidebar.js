...
const SELLER_NAV = [
    { href: '/pages/seller/dashboard.html', icon: 'dashboard', label: 'Seller Dashboard', key: 'dashboard' },
 ...
 * @param {string} containerId - ID of the container element (optional, defaults to finding .dashboard-nav)
...
export { ICONS, BUYER_NAV, SELLER_NAV };
